...
function clubfood_customize_register( $clubfood_wp_customize ) {
	...
	foreach ( $clubfood_colors as $clubfood_color ) {
		$clubfood_wp_customize->add_setting( $clubfood_color['slug'], array(
			'default'           => $clubfood_color['default'],
			'type'              => 'theme_mod',
			'capability'        => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_hex_color',
		) );
		$clubfood_wp_customize->add_control( new WP_Customize_Color_Control( $clubfood_wp_customize, $clubfood_color['slug'], array(
	...
	$clubfood_wp_customize->add_panel( 'widget_images', array(
		'priority'       => 70,
		'theme_supports' => '',
	...
	$clubfood_wp_customize->add_section( 'contact_background', array(
		'title'    => esc_html__( 'Contact Background', 'clubfood' ),
		'panel'    => 'widget_images',
		'priority' => 20,
	) );

	$clubfood_wp_customize->add_setting( 'contact_bg', array(
		'flex-width'  => true,
		'width'       => 1500,
		'flex-height' => true,
		'height'      => 900,
	...
	$clubfood_wp_customize->add_control( new WP_Customize_Image_Control( $clubfood_wp_customize, 'contact_background_image', array(
		'label'    => esc_html__( 'Add Contact Background Here, the width should be approx 1500px', 'clubfood' ),
		'section'  => 'contact_background',
		'settings' => 'contact_bg',
	) ) );

	$clubfood_wp_customize->add_section( 'sociallinks', array(
		'title'       => __( 'Social Links', 'clubfood' ),
		'description' => __( 'Add Your Social Links Here.', 'clubfood' ),
		'priority'    => '900',
	) );

	$clubfood_wp_customize->add_setting( 'clubfood_facebooklink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_facebooklink', array(
		'label'   => __( 'Facebook URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_twitterlink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_twitterlink', array(
		'label'   => __( 'Twitter URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_pinterestlink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_pinterestlink', array(
		'label'   => __( 'Pinterest URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_instagramlink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_instagramlink', array(
		'label'   => __( 'Instagram URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_linkedinlink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_linkedinlink', array(
		'label'   => __( 'LinkedIn URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_googlepluslink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_googlepluslink', array(
		'label'   => __( 'Google+ URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_youtubelink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_youtubelink', array(
		'label'   => __( 'YouTube URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_vimeo', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_vimeo', array(
		'label'   => __( 'Vimeo URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_tumblrlink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_tumblrlink', array(
		'label'   => __( 'Tumblr URL', 'clubfood' ),
		'section' => 'sociallinks',
	) );
	$clubfood_wp_customize->add_setting( 'clubfood_flickrlink', array(
		'default'           => '',
		'sanitize_callback' => 'esc_url_raw',
	) );
	$clubfood_wp_customize->add_control( 'clubfood_flickrlink', array(
...
function clubfood_bootstrap() {
	...
	wp_enqueue_style( 'fontawesome', get_template_directory_uri() . '/fontawesome/css/fontawesome.min.css' );
	wp_enqueue_style( 'clubfood-googlefonts', clubfood_google_fonts_url(), array(), null );
	wp_enqueue_style( 'clubfood-style', get_stylesheet_uri() );
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap.min.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'clubfood-script', get_template_directory_uri() . '/js/script.js', array( 'jquery' ), '', true );
}
...
function clubfood_google_fonts_url() {
	$font_families = array( 'Amatic+SC:400,700', 'Poppins:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i' );
	$query_args    = array(
...
function clubfood_woocommerce_cart_count() {
	if ( is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
		...
		?>
		<a href="<?php echo esc_html( WC()->cart->get_cart_url() ); ?>" title="<?php esc_html( 'View your shopping cart', 'clubfood' ); ?>" class="w-100 h-100 rounded-circle d-block">
...
function clubfood_excerpt_more( $link ) {
	...
	$link = sprintf( '<p class="link-more mt-4"><a href="%1$s" class="more-link text-dark">%2$s</a></p>',

...
<?php endif; ?>
		...
		<?php endif; ?>
		<?php if ( get_theme_mod( 'clubfood_googlepluslink' ) ) : ?>
		<li class="float-left border-left"><a href="<?php echo esc_url( get_theme_mod( 'clubfood_googlepluslink' ) ); ?>" class="text-white py-2 px-2 px-sm-3 d-block" target="_blank"><i class="fab fa-google-plus-g"></i></a></li>
		<?php endif; ?>
